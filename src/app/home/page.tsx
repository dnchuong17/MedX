        ...
        <main className="flex-1 px-4 pb-20">
            ...
            <div className="space-y-3">
              {challenges.map((challenge, idx) => (
                  <motion.div
                      ...
                      transition={{ delay: idx * 0.15 + 0.2, type: "spring", stiffness: 100 }}
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                { href: "/profile", label: "Profile", icon: <User className="h-5 w-5 text-gray-600" /> },
                { href: "/chatbot", label: "Chatbot", icon: <MessageCircle className="h-5 w-5 text-gray-600" /> },
                { href: "/community", label: "Community", icon: <Users className="h-5 w-5 text-gray-600" /> },
              ].map((item) => (
                  <motion.div
                      key={item.href}
                  ...
                  >
                    ...
                    >
                      <div className="bg-gray-200 p-2 rounded-full mb-1">{item.icon}</div>
