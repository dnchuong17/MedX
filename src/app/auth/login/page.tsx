        ...
        <form onSubmit={handleLogin} className="w-full">
            <div className="space-y-4">
                ...
                <div className="text-right">
                    <Link href="/forgot-password" className="text-indigo-600 text-sm font-medium">
                        Forget Password
                    </Link>
                </div>
        ...
        <div className="h-screen w-full flex flex-col bg-white">
            <div className="flex-1 flex flex-col px-6 pt-2 pb-6 mt-6">
                ...
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="flex-1 text-center text-xl font-semibold text-indigo-600">Log In</h1>
                ...
                <div className="flex border-b border-gray-200 mb-6">
                    <button
                        className={`px-6 py-2 text-center flex-1 ${activeTab === LoginTab.EMAIL ? 'text-indigo-600 border-b-2 border-indigo-600 font-medium' : 'text-gray-500'}`}
                        onClick={() => setActiveTab(LoginTab.EMAIL)}
                    >
                        Email
                    </button>
                    <button
                        className={`px-6 py-2 text-center flex-1 ${activeTab === LoginTab.PHONE ? 'text-indigo-600 border-b-2 border-indigo-600 font-medium' : 'text-gray-500'}`}
                        onClick={() => setActiveTab(LoginTab.PHONE)}
                    >
                        Phone
                    </button>
                    <button
                        className={`px-6 py-2 text-center flex-1 ${activeTab === LoginTab.WALLET ? 'text-indigo-600 border-b-2 border-indigo-600 font-medium' : 'text-gray-500'}`}
                ...
                <div className="mt-6 text-center">
                    <p className="text-gray-600">
                        ...
                        <Link href="/signup" className="text-indigo-600 font-medium ml-1">
                            Sign Up
                        </Link>
                    </p>
                </div>
